...
namespace NEA.Classes.Algorithms
{
    public class Kruskals<T>
    {
        ...
        private void PopulateNodesToVisit(ref List<T> nodesToVisit) //Works from testnig
        {
            ...
            {
                nodesToVisit.Add(i);
                Console.WriteLine("Adding " + i + " to the list of nodes to visit");
            }
            Console.WriteLine("nodesToVisit now contains: ");
        ...
        private void PopulateMSTAdjList() //Adds each key to the adjList. Works from testing
        {
            foreach (var i in graph.adjList.Keys)
            {
                ...
                Console.WriteLine("Adding node " + i + " to the minSpanTree");
            }
            Console.WriteLine("minSpanTree has been populated with: ");
            foreach (var i in minSpanTree.adjList.Keys)
            {
        ...
        public double FindMST()
        {
            ...
            do 
            {
                ...
                else
                {
                    ...
                    Console.WriteLine("Cycle detected, removing cyclic edge");
